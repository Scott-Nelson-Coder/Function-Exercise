...
let exclaimTwo = str => `${str.toUpperCase()} !!!`
...
let myFavColor = faveColorFinder("red")
...
function emailCheck(email) {
  ...
  if (email.includes("@")) {
    ...
    return " must provide a vailid email address"
  }
}

console.log(emailCheck("scottninlv@yahoo.com"))
...
function buyChocolate(gold) {
  let chocolateFrogs = 3
  return gold / chocolateFrogs
}

let totalFrogs = buyChocolate(4)
console.log(totalFrogs + 2)
...
let totalFrogs1 = buyChocolate(4)
...
let arrayIsAscending = isAcscending(sampleArray)
